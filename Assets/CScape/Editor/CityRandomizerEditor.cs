    ...
    public class CityRandomizerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
           ...
           //     ce.UpdateCity();
            ...
            ce.quadtree = EditorGUILayout.Toggle(new GUIContent("Use Slated streets (experimental)", "Use slated streets generation - this feature is experimental"), ce.quadtree);
