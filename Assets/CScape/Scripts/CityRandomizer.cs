            ...
            if (quadtree)
            {
                ...
                foreach (var child in tempListst)
                {
                    ...
                    if (Physics.Raycast(pos, fwd, out hit) && sM && 0 == 0 && !sM.protect)
                    {
                        ...
                        {
                            var rand = Mathf.FloorToInt(Random.Range(-(sM.blockWidth / 2), sM.blockWidth / 2));
                            sM.useSkewLR = true;
                ...
                foreach (var child in tempListst)
                {
                    ...
                    if (Physics.Raycast(pos, fwd, out hit) && sM && 0 == 0)
                    {
                        ...
                        {
                            var rand = Mathf.FloorToInt(Random.Range(-(sM.blockDepth / 2), sM.blockDepth / 2));
                            sM.useSkewFB = true;
