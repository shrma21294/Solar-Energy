...
//#if UNITY_EDITOR
   ...
   //     public GameObject[] greebleElements;
    ...
    //    private Bounds greebleAreaZ;
        ...
        public enum Alignment { Left, Not_Implemented };
        public Alignment[] alignTo = new Alignment[10];
                ...
                for (int i = 0; i < numberOfModifiers; i++)
                {
                    ...
                    if (rooftopElements[i] != null)
                    {
                        if (bmComponent.useAdvertising)
                        {
                            ...
                            //    Vector3 minLineZ = new Vector3(gameObject.transform.position.x + bmComponent.advertOffsetZ[z].x, gameObject.transform.position.y + bmComponent.advertOffsetY[z], gameObject.transform.position.z + bmComponent.advertOffsetX[z].y);
        ...
        public void MergeMeshes()
        {
            ...
            rooftopHolder[iteration].transform.position = gameObject.transform.position;
            rooftopHolder[iteration].transform.rotation = gameObject.transform.rotation;
            rooftopHolder[iteration].transform.localScale = gameObject.transform.localScale;
        }
